...
<template>
    <section class="bg-customHeader">
      <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div class="mr-auto place-self-center lg:col-span-7">
              <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl">兒童腹膜透析預測模型</h1>
          ...
          <div class="font-light text-gray-500 sm:text-lg">
              ...
              <section class="bg-customSimulation ">
                <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                    ...
                    <p class="mb-8 lg:mb-16 font-light text-left text-gray-500 sm:text-xl">
                    ...
                    <form action="#">
                      <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-6">
                        <div>
                        <label for="ID" class="block mb-2 text-sm font-medium text-gray-900">病歷號</label>
                        <input type="text" name="ID" id="ID" v-model="ID" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required>

                        <br>
                        <label for="countries" class="block mb-2 text-sm font-medium text-gray-900">選擇作答日期</label>
                      ...
                      <div class="flex items-center space-x-4">
                          <!-- Modal toggle -->
                        <button data-modal-target="Simulation" data-modal-toggle="Simulation" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="button">
                          Toggle modal
                        </button>
                      </div>
                  </form>
          ...
          <form action="#">
                <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-6">
                    <div>
                        ...
                        <input type="number" name="Sex" id="Sex" v-model="Sex" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required>
                    </div>
                    <div class="w-full">
                        <label for="PDage" class="block mb-2 text-sm font-medium text-gray-900">PDage</label>
                        <input type="number" name="PDage" id="PDage" v-model="PDage" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required>
                    </div>
                    <div>
                        <label for="BW" class="block mb-2 text-sm font-medium text-gray-900">BW</label>
                        <input type="number" name="BW" id="BW" v-model="BW" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required>
                    </div>                        
                    <div>
                        <label for="peritonitits" class="block mb-2 text-sm font-medium text-gray-900">peritonitits</label>
                        <input type="number" name="peritonitits" id="peritonitits" v-model="peritonitits" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required>
                    </div>
                    <div>
                        <label for="Exit" class="block mb-2 text-sm font-medium text-gray-900">Exit</label>
                        <input type="number" name="Exit" id="Exit" v-model="Exit" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required>
                    </div>
                    <div class="w-full">
                        <label for="PDuration" class="block mb-2 text-sm font-medium text-gray-900">PDuration</label>
                        <input type="number" name="PDuration" id="PDuration" v-model="PDuration" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required>
                    </div>
                    <div>
                        <label for="aWCCR" class="block mb-2 text-sm font-medium text-gray-900">aWCCR</label>
                        <input type="number" name="aWCCR" id="aWCCR" v-model="aWCCR" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required>
                    </div>                        
                    <div>
                        <label for="bKTV" class="block mb-2 text-sm font-medium text-gray-900">bKTV</label>
                        <input type="number" name="bKTV" id="bKTV"  v-model="bKTV" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5">
                    </div>
                    <div>
                        <label for="underly5" class="block mb-2 text-sm font-medium text-gray-900">underly5</label>
                        <input type="number" name="underly5" id="underly5" v-model="underly5" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required>
                    </div>
                    <div>
                        <label for="periRa2" class="block mb-2 text-sm font-medium text-gray-900">periRa2</label>
                        <input type="number" name="periRa2" id="periRa2" v-model="periRa2" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required>
                    </div>
                    <div class="w-full">
                        <label for="ENDnew2" class="block mb-2 text-sm font-medium text-gray-900">ENDnew2</label>
                        <input type="number" name="ENDnew2" id="ENDnew2" v-model="ENDnew2" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required>
                    </div>
                    <div>
                        <label for="ENDnew3" class="block mb-2 text-sm font-medium text-gray-900">ENDnew3</label>
                        <input type="number" name="ENDnew3" id="ENDnew3" v-model="ENDnew3" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required>
                    </div>                        
                    <!-- <div>
                        <label for="bKTV" class="block mb-2 text-sm font-medium text-gray-900">bKTV</label>
                ...
                <div class="flex items-center space-x-4">
                    <!-- Modal toggle -->
                <button data-modal-target="model" data-modal-toggle="model" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="button">
                    計算風險
                </button>
                </div>
            </form>
    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow ">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                ...
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-hide="model">
            ...
            <div class="p-4 md:p-5 space-y-4">
                ...
                <p :class="{'text-red-500': calculateRisk() > 0.5, 'text-green-500': calculateRisk() <= 0.5}" class="text-base leading-relaxed">
    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="p-4 md:p-5 space-y-4">
                ...
                <p :class="{'text-red-500': geneRisk === '超高風險' || geneRisk === '高風險', 'text-green-500': geneRisk === '低風險' || geneRisk === '超低風險'}" class="text-base leading-relaxed">
